...
#### 编译名称  ####
#APK
LOCAL_PACKAGE_NAME := EgarMedia
#Jar
# LOCAL_MODULE = EgarMediaUI

### 声明 资源文件 ###
LOCAL_RESOURCE_DIR := $(LOCAL_PATH)/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../../../PageUsbImage/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../../../PageRadio/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../../../PageUsbMusic/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../../../PageUsbVideo/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../../../PageBtMusic/res
### 声明 JAVA文件 & AIDL文件 ###
#JAVA
SRC_DIRS := java
SRC_DIRS += ../../../PageRadio/src
SRC_DIRS += ../../../PageUsbMusic/src
SRC_DIRS += ../../../PageUsbVideo/src
SRC_DIRS += ../../../PageUsbImage/src
SRC_DIRS += ../../../PageBtMusic/src
...
#### Use LIBRARIES ####
## .so
#LOCAL_JNI_SHARED_LIBRARIES := SO_libqtplayer
#LOCAL_JNI_SHARED_LIBRARIES +=
## .jar
LOCAL_STATIC_JAVA_LIBRARIES := android-support-v4
LOCAL_STATIC_JAVA_LIBRARIES += android-support-v7-appcompat
LOCAL_STATIC_JAVA_LIBRARIES += EGAR_COMMON
LOCAL_STATIC_JAVA_LIBRARIES += LIB_API_MUSIC
LOCAL_STATIC_JAVA_LIBRARIES += android.egar
LOCAL_STATIC_JAVA_LIBRARIES += LIB_COMMON
LOCAL_STATIC_JAVA_LIBRARIES += LIB_API_SCANNER
LOCAL_STATIC_JAVA_LIBRARIES += LIB_MEDIA
LOCAL_STATIC_JAVA_LIBRARIES += com.egar.manager.radio
LOCAL_STATIC_JAVA_LIBRARIES += btproxy_media
LOCAL_STATIC_JAVA_LIBRARIES += LETTER_SIDE_BAR
LOCAL_STATIC_JAVA_LIBRARIES += EGAR_RECYCLERVIEW
LOCAL_STATIC_JAVA_LIBRARIES += glide_full
## .aar
...
#LOCAL_PREBUILT_LIBS +=
## ^^ .jar 预编译 ^^
#LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := JAR_CarSettings_api:libs/CarSettings_api.jar
#LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES += JAR_android_egar:libs/android.egar.jar
## ^^ .aar 预编译 ^^
...
include $(CLEAR_VARS)
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := btproxy_media:../../../PageBtMusic/libs/com.egar.btproxy.jar
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := glide_full:../../../PageUsbImage/libs/glide-full-4.7.0.jar
include $(BUILD_MULTI_PREBUILT)
